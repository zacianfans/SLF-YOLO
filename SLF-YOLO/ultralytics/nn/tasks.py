...
from ultralytics.nn.modules import (
    ...
    C2f_SC_Block,
    GSConv, VoVGSCSP,Zoom_cat,Add,ScalSeq,
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            PSA,
            SCDown,
            C2fCIB,C2f_SC_Block,GSConv,VoVGSCSP
        }:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2fCIB,C2f_SC_Block,VoVGSCSP}:
